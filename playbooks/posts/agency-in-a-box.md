...
issueNumber: 10
permalink: /playbooks/agency-in-a-box/
tags:
  - agency
  - consulting
  - multi-tenant
...
- [**Hetzner**](#aff-hetzner): alternative VPS option named in the playbook
...
The operator this playbook is based on spent two weeks building it. He is an experienced agency owner. He picked the docker-compose route because he needed a client-ready platform, not a pile of custom scripts. He documented every failure mode. His honest take: "I almost quit five times. Here's what kept breaking and how I fixed it." We are sharing his path so you do not find the hard parts by hitting them yourself.
...
The middle path is the pattern in this playbook. You keep the high-touch sales motion you already have. You keep the ongoing monthly revenue. You stop rebuilding the same thing from scratch for every client. You build a platform once. You deploy a configured copy per client. You charge a productized monthly fee. You get the unit economics of software plus the close rate of services.
...
Before you onboard your second client, put the cap layer from [our budget cap playbook](/playbooks/ai-budget-cap/) in place. Per-tenant budgets, per-tenant daily caps, per-tenant alerts when approaching the cap.
...
This playbook is not just about the build. It is about the packaged business.
...
This playbook fits agencies and consultants who have proven out a delivery model and are ready to productize it.
...
- **[The One-Person Agency: Charge Agency Rates as a Solo Operator](/playbooks/one-person-agency/)**: The precursor pattern. If you are still delivering one-off services, start here and productize from there.
- **[He Spent $1,263 on AI in One Month. Then He Capped It.](/playbooks/ai-budget-cap/)**: The cost-control layer you must have before onboarding client number two.
- **[Teach Your AI to Stop Making the Same Mistake Twice](/playbooks/self-improving-agent/)**: The self-improvement layer that compounds across all your tenants. The whole book gets smarter every week without you touching each client.
