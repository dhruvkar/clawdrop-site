...
issueNumber: 7
permalink: /playbooks/trade-like-a-politician/
tags:
  - trading
  - stocks
  - automation
...
- **[Build a Polymarket Trading Bot](/playbooks/polymarket-trading-bot/)**: Apply the same AI trading principles to prediction markets instead of stocks.
- **[The One-Person Agency](/playbooks/one-person-agency/)**: Put your trading profits to work building a service business that runs on AI.
