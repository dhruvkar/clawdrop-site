...
issueNumber: 11
permalink: /playbooks/email-to-calendar/
tags:
  - email
  - calendar
  - gmail
...
- **[He Let an AI Triage 180 Emails a Day. Here's the Stack.](/playbooks/inbox-triage-agent/)**: The companion playbook. Where this one extracts events, that one decides which emails deserve your attention at all.
- **[Build an AI Life OS That Knows Your Entire Day (Before You Do)](/playbooks/ai-life-os/)**: The wider pattern. Email-to-calendar is one of 20 plays inside a complete personal-ops system; the Life OS playbook is the system.
- **[Automate Grocery Shopping With a Photo of a Recipe](/playbooks/grocery-autopilot/)**: Same architecture, different domain. Photo in, structured action out, the human-in-the-loop becomes optional once it's tuned.
