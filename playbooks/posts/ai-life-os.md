...
tags:
  ...
  - solopreneur
  - claude-code
permalink: /playbooks/ai-life-os/
---
...
The [AI Second Brain](/playbooks/ai-second-brain/) playbook is about building a searchable knowledge base from articles, notes, and research. That's your library.
...
- **[AI Second Brain (Karpathy Method)](/playbooks/ai-second-brain-karpathy/)**: Build the knowledge layer that pairs with your Life OS. Your library + your mirror = complete system.
- **[Run Your Business on AI](/playbooks/founder-runs-business-on-ai/)**: Take the Life OS concept further and automate actual business operations, not just tracking.
- **[The One-Person Agency](/playbooks/one-person-agency/)**: Use your Life OS insights to deliver agency-quality work as a solo operator.
