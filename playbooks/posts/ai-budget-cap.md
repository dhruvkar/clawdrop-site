...
issueNumber: 10
permalink: /playbooks/ai-budget-cap/
tags:
  - cost-control
  - budget
  - ai-spend
...
This playbook fits anyone whose AI bill is no longer trivial.
...
- **[Cut Your AI Agent Costs by 97% with Multi-Model Routing](/playbooks/multi-model-routing/)**: The deeper routing pattern. Pair with this for the full cost-control stack.
- **[Run Your AI Assistant 24/7 for $0/Month](/playbooks/oracle-free-tier/)**: The always-on hosting side. Matters if you are running the cap layer plus agents on your own infrastructure.
- **[Teach Your AI to Stop Making the Same Mistake Twice](/playbooks/self-improving-agent/)**: The self-improvement layer that generates fewer wasted calls in the first place. Cost control starts before the call, not just at the gate.
