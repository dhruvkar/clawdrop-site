...
issueNumber: 12
permalink: /blueprints/custom-podcast-feed/
tags:
  - podcast
  - elevenlabs
  - audio
...
This blueprint fits anyone whose job runs on staying current and whose time runs out before the reading does.
...
- **[Your AI Remembers Everything So You Don't Have To](/blueprints/ai-second-brain/).** The memory layer that pairs perfectly with the morning show. Whatever the show surfaces, the second brain catches and saves for later.
- **[Build an AI Life OS That Knows Your Entire Day (Before You Do)](/blueprints/ai-life-os/).** Same operator philosophy, broader scope. Your morning show is one slice of the larger Life OS pattern.
- **[He Let an AI Triage 180 Emails a Day. Here's the Stack.](/blueprints/inbox-triage-agent/).** The other half of the morning. Triage handles the inbox while the show handles the reading queue. Together they buy back the entire first hour of your day.
